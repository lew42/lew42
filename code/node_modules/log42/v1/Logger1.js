...
var LoggerView = View.extend({
	...
	header: View.sub({
		...
		label: View.sub(function(){
			...
			this.append(this.parent.parent.logr.count() + " - ");
...
var Logger = module.exports = Sfn.extend({
	...
	init_fn_setup: function(){
		...
		this.fn.groupc = this.groupc.bind(this);
	},
	setter: function(value, ctx){
		if (is.bool(value))
			this.enabled = this.fn.enabled = value;
	},
	count: function(){
		var count = this.logs.length;
		for (var i = 0; i < this.logs.length; i++){
			count += this.logs[i].count();
		}
		return count;
	},
