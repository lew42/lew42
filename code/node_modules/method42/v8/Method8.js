...
var MethodFlarg = Base2.extend({
	...
	buildSelf: function(flog){
		// flog.str, flog.styles, flog.unstyled
		var flarg = this.fn.call(this.ctx);
		// what can be returned here? any flarg?
		// "str", ["str", "style"], flog/flarg, or anything else?
		// we can't just send it through the flog.buildFlarg function without first converting it to a styled or unstyled flarg
	},
...
var Method = module.exports = Base2.extend({
	...
	test: new MethodFlarg(false, function(){
		return "hello";
	}).wrapper,
	logMethod: "group",
	fnoop: fnoop,
	...
	group: function(){
		this.log.fm(this.logMethod, this.test(), this.ctx(), this.method())();
