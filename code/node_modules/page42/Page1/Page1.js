...
var Page1 = module.exports = Path.extend({
	...
	render: function(){
		console.log("attempting to render page", this.route.path);
		if (this.parent && this.parent.view){
			console.log("found parent.view");
			this.parent.view.captureFn(function(){
				console.log("rendering page", this.route.path);
				View(this.route.path);

			}.bind(this));
		} else {
			View(this.route.path, "non-captured");
		}
	},
	activate: function(){
