var Mod1 = require("mod42/v3");
var is = require("util42").is;
var shared = require("../shared");

// history is no longer needed... wow that was dumb
...
var Route6 = Mod1.extend({
	...
	add: function(route){
		...
		if (match){
			...
			console.error("This will never happen, because matchChildren always returns a match...");
